[![React App CI](https://github.com/LeonardPeris/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/LeonardPeris/ci-cd-with-actions/actions/workflows/ci.yml)
